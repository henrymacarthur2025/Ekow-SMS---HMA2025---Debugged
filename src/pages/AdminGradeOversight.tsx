...
export default function AdminGradeOversight({ navigate }: { navigate: (path: string) => void }) {
    ...
    const gradesData = [
        { id: 'STU001', name: 'Kwame Mensah', score: 85, grade: 'A', status: 'Completed', notes: '' },
        { id: 'STU002', name: 'Abena Osei', score: 92, grade: 'A', status: 'Completed', notes: '' },
        { id: 'STU003', name: 'Kofi Annan', score: null, grade: '-', status: 'Pending', notes: 'Absent for exam' },
        { id: 'STU004', name: 'Ama Asare', score: 78, grade: 'B', status: 'Completed', notes: '' },
        { id: 'STU005', name: 'Yaw Boakye', score: 65, grade: 'C', status: 'Completed', notes: '' },
        { id: 'STU006', name: 'Akua Addo', score: 45, grade: 'F', status: 'Completed', notes: 'Requires intervention' },
        { id: 'STU007', name: 'Kwasi Owusu', score: null, grade: '-', status: 'Pending', notes: 'Medical leave' },
        { id: 'STU008', name: 'Yaa Nsiah', score: 88, grade: 'A', status: 'Completed', notes: '' },
    ];
