...
export default function NoConnectionState({ navigate }: NoConnectionStateProps) {
        ...
        <div className="min-h-screen bg-[#F7F8FA] flex flex-col md:flex-row font-sans">
            ...
            <main className="flex-1 flex flex-col min-h-0 overflow-hidden">
                ...
                <header className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between sticky top-0 z-20">
                    <h1 className="text-2xl font-bold text-[#1F3864]">Connection Error</h1>
                ...
                {/* Content Area - Centered No Connection State */}
                <div className="flex-1 overflow-y-auto p-4 md:p-6 flex items-center justify-center">
                    <div className="flex flex-col items-center justify-center text-center max-w-md w-full p-8 bg-white rounded-xl shadow-sm border border-gray-100">
                        ...
                        <p className="text-gray-500 mb-6">We couldn't reach the server. Please check your mobile data or Wi-Fi connection and try again.</p>
                        <button onClick={() => navigate('empty_state')} className="flex items-center gap-2 px-6 py-2.5 bg-[#1F3864] text-white rounded-lg font-medium hover:bg-[#152643] transition-colors">
