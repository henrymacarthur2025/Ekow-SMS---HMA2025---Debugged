...
export default function AdminAttendanceOversight({ navigate }: { navigate: (path: string) => void }) {
    ...
    const auditTrail = [
        ...
        { id: 2, date: 'Oct 14, 2023 02:15 PM', user: 'Mrs. Sarah Osei', action: 'Changed Ama Asare from Absent to Late', reason: 'Student arrived after register was closed' },
        { id: 3, date: 'Oct 12, 2023 09:00 AM', user: 'Principal Mensah', action: 'Changed Akua Addo from Late to Absent', reason: 'Student left school grounds without permission' },
    ];
            ...
            <div className={`flex-1 flex flex-col h-screen md:ml-[260px] transition-all duration-300 ${isAuditPanelOpen ? 'mr-0 lg:mr-[360px]' : 'mr-0'}`}>
                ...
                <header className="h-[72px] bg-white border-b border-gray-200 px-4 md:px-8 flex items-center justify-between shrink-0">
                    <div className="flex items-center gap-4">
                        ...
                        <h2 className="text-xl font-bold text-[#1F3864] hidden sm:block">Attendance Oversight</h2>
                    </div>
                    <div className="flex items-center gap-4">
                        <button 
                ...
                <main className="flex-1 p-4 md:p-8 overflow-y-auto">
                    <div className="max-w-6xl mx-auto w-full">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                            <div>
                                <h2 className="text-2xl font-bold text-[#1F3864] mb-1">Daily Attendance & Corrections</h2>
                                <p className="text-sm text-gray-500 font-semibold">Review class attendance records and manage status corrections.</p>
                            </div>
                        </div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                                ...
                                <div className="relative w-full sm:w-48">
                                    ...
                                    <input
                                        ...
                                        className="block w-full pl-9 pr-3 py-2.5 border border-gray-200 rounded-lg bg-white focus:outline-none focus:border-[#1F3864] focus:ring-1 focus:ring-[#1F3864] sm:text-sm font-semibold text-[#1F3864]"
                                    />
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                            ...
                            <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xl font-bold text-[#1F3864]">20</p>
                                </div>
                            </div>
                            <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex items-center gap-4">
                            ...
                            <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-xs font-bold text-gray-500 uppercase">Late</p>
                                    <p className="text-xl font-bold text-[#1F3864]">2</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <table className="w-full text-left border-collapse min-w-[800px]">
                                    <thead>
                                        <tr className="bg-[#1F3864] text-white">
                                            ...
                                            <th className="py-3 px-5 text-sm font-bold">Time</th>
                                            <th className="py-3 px-5 text-sm font-bold">Notes / Reason</th>
